...
MayorCrecimiento = gapminder[gapminder['country'].isin(['Botswana','Singapore','Korea, Rep.','Taiwan','Equatorial Guinea'])]
...
def plot():
    ...
    .add(so.Line(color='gray'), so.Agg(), data=gapminder, x = 'year', y = 'gdpPercap')
